...
export default function RegisterPage() {
  ...
  return (
    <div className="absolute w-full bg-white top-0 left-0 right-0 bottom-0">
      <form
              ...
              {allergies.map((allergy) => (
                <div key={allergy._id} className="flex items-center">
                  <input
                    type="checkbox"
                    id={allergy._id}
                    checked={user.allergies.some((a) => a._ref === allergy._id)}
              ...
              {products.map((product) => (
                <div key={product._id} className="flex items-center">
                  <input
                    type="checkbox"
                    id={product._id}
                    checked={user.favoriteProducts.some(
